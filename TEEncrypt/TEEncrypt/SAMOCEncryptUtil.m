...
////
//
//#import "SAMOCEncryptUtil.h"
//
//@implementation SAMOCEncryptUtil
//
...
//}
//
//static SecKeyRef sam_generatePublicKeyRef()
//{
//    
//}
//
//int sam_topRSAEncrypt(const char *buf, size_t buf_length, void **outdata, size_t *out_Length)
//{
...
//    if(!keyRef){
//        keyRef = sam_generatePublicKeyRef();
////        keyRef = sam_addPublicKey([[NSString alloc] initWithBytes:publickey length:key_length encoding:NSUTF8StringEncoding]);
//    }
//    
//    if (!keyRef) {
//        return -1;

...
+ (CocoaSecurityResult *)aesDecryptWithBase64:(NSString *)data key:(NSString *)key
{
    ...
    return [self aesDecryptWithBase64:data key:keydata iv:ivdata];
